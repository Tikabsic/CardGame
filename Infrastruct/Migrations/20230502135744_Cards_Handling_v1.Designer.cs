...
namespace Infrastruct.Migrations
{
    ...
    [Migration("20230502135744_Cards_Handling_v1")]
    partial class Cards_Handling_v1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CardEntities.DeckCard", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.CardEntities.PlayerCard", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.CardEntities.StackCard", b =>
                {
                    ...
                    b.HasKey("StackId", "CardId");

                    b.HasIndex("CardId");

                    b.ToTable("StackCards");
                });
            ...
            modelBuilder.Entity("Domain.Entities.CardEntities.DeckCard", b =>
                {
                    b.HasOne("Domain.Entities.CardEntities.Card", "Card")
                        .WithMany("DeckCards")
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.CardEntities.Deck", "Deck")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("Domain.Entities.CardEntities.StackCard", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.CardEntities.Stack", "Stack")
                        .WithMany("Cards")
